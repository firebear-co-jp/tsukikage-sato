  ...
  const plans = [
    {
      ...
      href: '/tsukikage-sato/plans/romantic-special/',
      category: 'romantic',
      popular: true,
    },
    {
      ...
      href: '/tsukikage-sato/plans/gourmet-seasonal/',
      category: 'gourmet',
    },
    {
      id: 'relax-onsen',
      ...
      href: '/tsukikage-sato/plans/relax-onsen/',
      category: 'relax',
    },
    {
      id: 'family-friendly',
      ...
      price: '35,000',
      priceNote: '〜（大人2名様1室）',
      features: ['和室B', 'お子様メニュー', '貸切風呂利用', '家族向けアメニティ'],
      href: '/tsukikage-sato/plans/family-friendly/',
      category: 'family',
    },
    {
      id: 'solo-healing',
      ...
      price: '28,000',
      priceNote: '〜（1名様）',
      features: ['和室A', '一人用会席料理', '貸切風呂利用', '読書スペース'],
      href: '/tsukikage-sato/plans/solo-healing/',
      category: 'solo',
    },
    {
      id: 'valley-view',
      ...
      href: '/tsukikage-sato/plans/valley-view/',
      category: 'view',
      popular: true,
    },
    {
      ...
      href: '/tsukikage-sato/plans/premium-suite/',
      category: 'romantic',
      premium: true,
    },
  ];
